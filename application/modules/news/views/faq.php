						...
						<?php if ($faq): ?>
							...
							<tr>
								...
								<td class="text-center">
									...
									<a onclick="return confirm('Anda yakin akan menghapus FAQ ini?')" href="<?php echo site_url('news/hapusfaq/').$faq->id ?>" class="btn-sm btn-danger"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
						<?php endforeach ?>
					<?php endif ?>
