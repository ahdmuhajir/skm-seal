	...
	<div class="container">
		<form action="<?php echo site_url('kuis/hasil') ?>" method="post" accept-charset="utf-8" class="mt-4">
			...
			foreach ($soal as $soal): ?>
				<input type="hidden" name="id_pertanyaan[]" value="<?php echo $soal->id_pertanyaan ?>">
				<h4>P : <?php echo $no++ ?></h4>
				...
				<div class="row">
					<div class="col">
						<div class="form-check form-check-inline">
							<input required class="form-check-input" type="radio" name="pilihan[<?php echo $soal->id_pertanyaan?>][]" id="inlineRadio1" value="a">
				...
				<div class="row">
					<div class="col">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="pilihan[<?php echo $soal->id_pertanyaan?>][]" id="inlineRadio1" value="b">
				...
				<div class="row">
					<div class="col">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="pilihan[<?php echo $soal->id_pertanyaan?>][]" id="inlineRadio1" value="c">
				...
				<div class="row mb-4">
					<div class="col">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="pilihan[<?php echo $soal->id_pertanyaan?>][]" id="inlineRadio1" value="d">
