...
<section class="content" style="margin:0px -10px;">
  <div class="box" style="margin-top: -10px">
	...
	<div class="col-sm-3 col-xs-12" style="margin-top: 0.3em">
         <a href="#" class="btn bg-red pull-right" id="cetak_laporan_akhir">
         ...
         <tbody>
          <?php foreach ($rekap as $data): 
            ...
            <tr>
              ...
              <td class="text-center" style="cursor: pointer" onclick="sangat_puas('<?php echo $data['id_pertanyaan'] ?>')"><?php echo $data['sp'] != null ? '<strong>'.$data['sp'].'</strong>' : '-' ?></td>
              <td class="text-center" style="cursor: pointer" onclick="puas('<?php echo $data['id_pertanyaan'] ?>')"><?php echo $data['p'] != null ? '<strong>'.$data['p'].'</strong>' : '-' ?></td>
              <td class="text-center" style="cursor: pointer" onclick="kurang('<?php echo $data['id_pertanyaan'] ?>')"><?php echo $data['tp'] != null ? '<strong>'.$data['tp'].'</strong>' : '-' ?></td>
              <td class="text-center" style="cursor: pointer" onclick="kecewa('<?php echo $data['id_pertanyaan'] ?>')"><?php echo $data['kec'] != null ? '<strong>'.$data['kec'].'</strong>' : '-' ?></td>
...
<section class="col-xl-3 col-lg-6 col-md-6 col-xs-12 connectedSortable">
  ...
  <div class="box box-solid" style="height:300px;">
    <div class="box-header">
      ...
      <h3 class="box-title">Pekerjaan Responden</h3>
...
<section class="col-xl-3 col-lg-6 col-md-6 col-xs-12 connectedSortable">
  ...
  <div class="box box-solid" style="height:300px;">
    <div class="box-header">
      ...
      <h3 class="box-title"> Pendidikan Responden</h3>
